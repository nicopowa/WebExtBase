...
*								return true; // or callback fired by super class
*							}
*
...
*		- can send to web via window.postMessage (same tab only, send to other web script through background > content > window.postMessage)
*		- can send to popup via chrome.runtime
*
*	Web :
*		- can send to background via chrome.runtime
